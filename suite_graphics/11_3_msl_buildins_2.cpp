    ...
    class my_app : public motor::application::app
    {
        ...
        virtual void_t on_init( void_t ) noexcept
        {
...

            {
                ...
                // render shader
                {
                    ...
                    motor::string_t shd ;
                    auto const res =  db.load( motor::io::location_t( "shaders.13_msl_buildins_2.render.msl" ) ).wait_for_operation( [&] ( char_cptr_t data, size_t const sib, motor::io::result const ) 
                    { 
        ...
        virtual void_t on_graphics( motor::application::app::graphics_data_in_t gdi ) noexcept 
        {
            ...
            msl_obj->for_each( [&]( size_t const, motor::graphics::render_object_t::variable_set_cref_t vs )
            {
                ...
                {
                    auto * var = vs.vs->data_variable<motor::math::vec2f_t>( "u_uv" ) ;
